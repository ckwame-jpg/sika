...
class Settings(BaseSettings):
    ...
    auto_trading_local_time: str = "10:15"
    auto_trading_max_orders_per_day: int = 5
    auto_trading_market_scope: str = "nba_mlb_current_slate"
    auto_trading_allow_parlays: bool = False
    openai_api_key: str = ""
