...
export type PaperTotalsRead = Wire<Schema<"PaperTotalsRead">>;
...
export type PaperParlayQuoteRequest = Schema<"PaperParlayQuoteRequest">;
export type PaperParlayQuoteRead = Wire<Schema<"PaperParlayQuoteRead">>;
