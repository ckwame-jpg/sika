...
/**
 * Shell-level API availability boundary.
 *
 * Wraps page content and shows a single clear blocker state when the backend
 * is unreachable, instead of letting every table/card fail independently.
 */
